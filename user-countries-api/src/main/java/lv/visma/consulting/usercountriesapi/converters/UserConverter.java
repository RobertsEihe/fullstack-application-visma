...
import static lv.visma.consulting.usercountriesapi.converters.CountryConverter.entityToDTOList;
...
public class UserConverter {
    public UserDto toDto(UserEntity userEntity) {
        ...
        return UserDto.builder()
                ...
                .favoriteCountries(entityToDTOList(userEntity.getFavoriteCountries()))
                .build();
    }
